...
def parse_opt():
    ...
    parser.add_argument(
        '--max_video_duration', type=int, default=20
        , help='The maximum video duration of the training dataset'
    )

    # --------------eval arguments-------------------
    model_folder = './save_msr'
    ...
    parser.add_argument('--results_path', type=str, default='./results_msr/')
    parser.add_argument('--dump_path', type=int, default=0,
                        help='Write image paths along with predictions into vis json? (1=yes,0=no)')
    parser.add_argument('--eval_gpu', type=str, default='0',
